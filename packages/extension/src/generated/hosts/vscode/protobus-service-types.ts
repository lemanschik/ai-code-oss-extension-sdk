...
export type FileServiceHandlers = {
     ...
     subscribeToWorkspaceUpdates:(controller: Controller, request: proto.cline.EmptyRequest, responseStream: StreamingResponseHandler<proto.cline.StringArray>, requestId?: string) => Promise<void>
}
