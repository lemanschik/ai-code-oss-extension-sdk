...
export const WatchServiceService = {
  /** Subscribe to file changes */
  subscribeToFile: {
    path: "/host.WatchService/subscribeToFile",
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: SubscribeToFileRequest) => Buffer.from(SubscribeToFileRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => SubscribeToFileRequest.decode(value),
    responseSerialize: (value: FileChangeEvent) => Buffer.from(FileChangeEvent.encode(value).finish()),
    responseDeserialize: (value: Buffer) => FileChangeEvent.decode(value),
  },
} as const;
