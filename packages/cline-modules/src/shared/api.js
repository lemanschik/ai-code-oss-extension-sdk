...
export const openRouterDefaultModelInfo = {
    ...
    cacheWritesPrice: 3.75,
    cacheReadsPrice: 0.3,
    description: "Claude Sonnet 4 delivers superior intelligence across coding, agentic search, and AI agent capabilities. It's a powerful choice for agentic coding, and can complete tasks across the entire software development lifecycle—from initial planning to bug fixes, maintenance to large refactors. It offers strong performance in both planning and solving for complex coding tasks, making it an ideal choice to power end-to-end software development processes.\n\nRead more in the [blog post here](https://www.anthropic.com/claude/sonnet)",
};
...
export const vertexGlobalModels = Object.fromEntries(Object.entries(vertexModels).filter(([_k, v]) => v.hasOwnProperty("supportsGlobalEndpoint")));
...
export const openAiNativeDefaultModelId = "gpt-4.1";
...
export const groqDefaultModelId = "moonshotai/kimi-k2-instruct";
