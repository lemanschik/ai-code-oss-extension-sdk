...
const FileServiceHandlers = {
    ...
    subscribeToWorkspaceUpdates: subscribeToWorkspaceUpdates,
};
const McpServiceHandlers = {
...
const SlashServiceHandlers = {
    reportBug: reportBug,
    condense: condense,
};
const StateServiceHandlers = {
