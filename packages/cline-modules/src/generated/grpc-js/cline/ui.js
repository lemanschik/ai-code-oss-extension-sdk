...
(function (WebviewProviderType) {
    WebviewProviderType[WebviewProviderType["SIDEBAR"] = 0] = "SIDEBAR";
    WebviewProviderType[WebviewProviderType["TAB"] = 1] = "TAB";
    WebviewProviderType[WebviewProviderType["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(WebviewProviderType || (WebviewProviderType = {}));
export function webviewProviderTypeFromJSON(object) {
    switch (object) {
        case 0:
        case "SIDEBAR":
...
export function webviewProviderTypeToJSON(object) {
    switch (object) {
...
export var ClineMessageType;
(function (ClineMessageType) {
    ClineMessageType[ClineMessageType["ASK"] = 0] = "ASK";
    ClineMessageType[ClineMessageType["SAY"] = 1] = "SAY";
    ClineMessageType[ClineMessageType["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClineMessageType || (ClineMessageType = {}));
export function clineMessageTypeFromJSON(object) {
    switch (object) {
        case 0:
        case "ASK":
...
export function clineMessageTypeToJSON(object) {
    switch (object) {
...
(function (ClineAsk) {
    ...
    ClineAsk[ClineAsk["AUTO_APPROVAL_MAX_REQ_REACHED"] = 10] = "AUTO_APPROVAL_MAX_REQ_REACHED";
    ClineAsk[ClineAsk["BROWSER_ACTION_LAUNCH"] = 11] = "BROWSER_ACTION_LAUNCH";
    ClineAsk[ClineAsk["USE_MCP_SERVER"] = 12] = "USE_MCP_SERVER";
    ClineAsk[ClineAsk["NEW_TASK"] = 13] = "NEW_TASK";
    ClineAsk[ClineAsk["CONDENSE"] = 14] = "CONDENSE";
    ClineAsk[ClineAsk["REPORT_BUG"] = 15] = "REPORT_BUG";
    ClineAsk[ClineAsk["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClineAsk || (ClineAsk = {}));
export function clineAskFromJSON(object) {
    switch (object) {
        case 0:
        case "FOLLOWUP":
...
export function clineAskToJSON(object) {
    switch (object) {
...
export function clineSayFromJSON(object) {
    switch (object) {
        case 0:
        case "TASK":
...
export function clineSayToJSON(object) {
    switch (object) {
        case ClineSay.TASK:
            return "TASK";
        case ClineSay.ERROR:
...
(function (ClineSayToolType) {
    ...
    ClineSayToolType[ClineSayToolType["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClineSayToolType || (ClineSayToolType = {}));
export function clineSayToolTypeFromJSON(object) {
    switch (object) {
        case 0:
...
export function clineSayToolTypeToJSON(object) {
    switch (object) {
...
(function (BrowserAction) {
    ...
    BrowserAction[BrowserAction["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(BrowserAction || (BrowserAction = {}));
export function browserActionFromJSON(object) {
    switch (object) {
        case 0:
        case "LAUNCH":
...
export function browserActionToJSON(object) {
    switch (object) {
...
export var McpServerRequestType;
(function (McpServerRequestType) {
    ...
    McpServerRequestType[McpServerRequestType["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(McpServerRequestType || (McpServerRequestType = {}));
export function mcpServerRequestTypeFromJSON(object) {
    switch (object) {
        case 0:
        case "USE_MCP_TOOL":
...
export function mcpServerRequestTypeToJSON(object) {
    switch (object) {
...
export var ClineApiReqCancelReason;
(function (ClineApiReqCancelReason) {
    ...
    ClineApiReqCancelReason[ClineApiReqCancelReason["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClineApiReqCancelReason || (ClineApiReqCancelReason = {}));
export function clineApiReqCancelReasonFromJSON(object) {
    switch (object) {
        case 0:
...
export function clineApiReqCancelReasonToJSON(object) {
    switch (object) {
...
function createBaseWebviewProviderTypeRequest() {
    return { metadata: undefined, providerType: 0 };
}
export const WebviewProviderTypeRequest = {
...
function createBaseConversationHistoryDeletedRange() {
...
function createBaseClineSayTool() {
...
function createBaseClineSayBrowserAction() {
...
function createBaseBrowserActionResult() {
...
function createBaseClineAskUseMcpServer() {
...
function createBaseClinePlanModeResponse() {
...
function createBaseClineAskQuestion() {
...
function createBaseClineAskNewTask() {
    return { context: "" };
}
...
function createBaseApiReqRetryStatus() {
...
function createBaseClineApiReqInfo() {
    return {
        request: "",
        tokensIn: 0,
        tokensOut: 0,
...
function createBaseClineMessage() {
    return {
        ts: 0,
        type: 0,
        ask: 0,
...
export const ClineMessage = {
    ...
    toJSON(message) {
        ...
        if (message.conversationHistoryDeletedRange !== undefined) {
            obj.conversationHistoryDeletedRange = ConversationHistoryDeletedRange.toJSON(message.conversationHistoryDeletedRange);
        }
        if (message.sayTool !== undefined) {
...
export const UiServiceService = {
    ...
    scrollToSettings: {
        ...
        responseSerialize: (value) => Buffer.from(KeyValuePair.encode(value).finish()),
        responseDeserialize: (value) => KeyValuePair.decode(value),
    },
    /** Marks the current announcement as shown and returns whether an announcement should still be shown */
    onDidShowAnnouncement: {
    ...
    subscribeToMcpButtonClicked: {
        ...
        requestStream: false,
        responseStream: true,
        requestSerialize: (value) => Buffer.from(WebviewProviderTypeRequest.encode(value).finish()),
        requestDeserialize: (value) => WebviewProviderTypeRequest.decode(value),
    ...
    subscribeToPartialMessage: {
        ...
        requestSerialize: (value) => Buffer.from(EmptyRequest.encode(value).finish()),
        requestDeserialize: (value) => EmptyRequest.decode(value),
        responseSerialize: (value) => Buffer.from(ClineMessage.encode(value).finish()),
        responseDeserialize: (value) => ClineMessage.decode(value),
    },
    /** Subscribe to theme change events */
    subscribeToTheme: {
        path: "/cline.UiService/subscribeToTheme",
        requestStream: false,
        responseStream: true,
        requestSerialize: (value) => Buffer.from(EmptyRequest.encode(value).finish()),
        requestDeserialize: (value) => EmptyRequest.decode(value),
