...
export var PlanActMode;
(function (PlanActMode) {
    PlanActMode[PlanActMode["PLAN"] = 0] = "PLAN";
    PlanActMode[PlanActMode["ACT"] = 1] = "ACT";
    PlanActMode[PlanActMode["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(PlanActMode || (PlanActMode = {}));
export function planActModeFromJSON(object) {
    switch (object) {
        case 0:
        case "PLAN":
...
export function planActModeToJSON(object) {
    switch (object) {
...
export var TelemetrySettingEnum;
(function (TelemetrySettingEnum) {
    TelemetrySettingEnum[TelemetrySettingEnum["UNSET"] = 0] = "UNSET";
    TelemetrySettingEnum[TelemetrySettingEnum["ENABLED"] = 1] = "ENABLED";
    TelemetrySettingEnum[TelemetrySettingEnum["DISABLED"] = 2] = "DISABLED";
    TelemetrySettingEnum[TelemetrySettingEnum["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(TelemetrySettingEnum || (TelemetrySettingEnum = {}));
export function telemetrySettingEnumFromJSON(object) {
    switch (object) {
        case 0:
        case "UNSET":
...
export function telemetrySettingEnumToJSON(object) {
    switch (object) {
...
function createBaseTerminalProfiles() {
    return { profiles: [] };
}
    ...
    fromJSON(object) {
        return {
            profiles: globalThis.Array.isArray(object?.profiles)
                ? object.profiles.map((e) => TerminalProfile.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
...
function createBaseTerminalProfile() {
...
function createBaseTerminalProfileUpdateResponse() {
...
function createBaseTogglePlanActModeRequest() {
...
function createBaseChatContent() {
...
export const ChatContent = {
    ...
    fromJSON(object) {
        return {
            ...
            images: globalThis.Array.isArray(object?.images) ? object.images.map((e) => globalThis.String(e)) : [],
...
function createBaseResetStateRequest() {
...
function createBaseAutoApprovalSettingsRequest() {
    return {
        metadata: undefined,
        version: 0,
        enabled: false,
    ...
    fromJSON(object) {
        return {
            ...
            favorites: globalThis.Array.isArray(object?.favorites)
                ? object.favorites.map((e) => globalThis.String(e))
                : [],
        };
    },
    toJSON(message) {
...
function createBaseAutoApprovalSettingsRequest_Actions() {
    return {
        readFiles: false,
...
export const AutoApprovalSettingsRequest_Actions = {
    encode(message, writer = new BinaryWriter()) {
...
function createBaseTelemetrySettingRequest() {
...
export const UpdateSettingsRequest = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.openaiReasoningEffort !== undefined) {
            writer.uint32(122).string(message.openaiReasoningEffort);
        }
...
export const ApiConfiguration = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.huaweiCloudMaasApiKey !== undefined) {
            writer.uint32(450).string(message.huaweiCloudMaasApiKey);
        }
    ...
    fromJSON(object) {
        return {
            ...
            favoritedModelIds: globalThis.Array.isArray(object?.favoritedModelIds)
                ? object.favoritedModelIds.map((e) => globalThis.String(e))
                : [],
...
function createBaseUpdateTerminalConnectionTimeoutRequest() {
...
function createBaseUpdateTerminalConnectionTimeoutResponse() {
    return { timeoutMs: undefined };
}
...
export const StateServiceService = {
    getLatestState: {
        ...
        responseSerialize: (value) => Buffer.from(State.encode(value).finish()),
        responseDeserialize: (value) => State.decode(value),
    },
    updateTerminalConnectionTimeout: {
        path: "/cline.StateService/updateTerminalConnectionTimeout",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(UpdateTerminalConnectionTimeoutRequest.encode(value).finish()),
        requestDeserialize: (value) => UpdateTerminalConnectionTimeoutRequest.decode(value),
        responseSerialize: (value) => Buffer.from(UpdateTerminalConnectionTimeoutResponse.encode(value).finish()),
        responseDeserialize: (value) => UpdateTerminalConnectionTimeoutResponse.decode(value),
    },
    updateTerminalReuseEnabled: {
        path: "/cline.StateService/updateTerminalReuseEnabled",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(BooleanRequest.encode(value).finish()),
        requestDeserialize: (value) => BooleanRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Empty.encode(value).finish()),
        responseDeserialize: (value) => Empty.decode(value),
    },
    updateDefaultTerminalProfile: {
        path: "/cline.StateService/updateDefaultTerminalProfile",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(StringRequest.encode(value).finish()),
        requestDeserialize: (value) => StringRequest.decode(value),
        responseSerialize: (value) => Buffer.from(TerminalProfileUpdateResponse.encode(value).finish()),
        responseDeserialize: (value) => TerminalProfileUpdateResponse.decode(value),
    },
    getAvailableTerminalProfiles: {
        ...
        requestSerialize: (value) => Buffer.from(EmptyRequest.encode(value).finish()),
        requestDeserialize: (value) => EmptyRequest.decode(value),
        responseSerialize: (value) => Buffer.from(TerminalProfiles.encode(value).finish()),
        responseDeserialize: (value) => TerminalProfiles.decode(value),
    },
    subscribeToState: {
    ...
    resetState: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(ResetStateRequest.encode(value).finish()),
        requestDeserialize: (value) => ResetStateRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Empty.encode(value).finish()),
        responseDeserialize: (value) => Empty.decode(value),
    },
    togglePlanActModeProto: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(TogglePlanActModeRequest.encode(value).finish()),
        requestDeserialize: (value) => TogglePlanActModeRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Boolean.encode(value).finish()),
        responseDeserialize: (value) => Boolean.decode(value),
    },
    updateAutoApprovalSettings: {
        path: "/cline.StateService/updateAutoApprovalSettings",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(AutoApprovalSettingsRequest.encode(value).finish()),
        requestDeserialize: (value) => AutoApprovalSettingsRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Empty.encode(value).finish()),
        responseDeserialize: (value) => Empty.decode(value),
    },
    updateSettings: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(UpdateSettingsRequest.encode(value).finish()),
        requestDeserialize: (value) => UpdateSettingsRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Empty.encode(value).finish()),
        responseDeserialize: (value) => Empty.decode(value),
    },
    updateTelemetrySetting: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(TelemetrySettingRequest.encode(value).finish()),
        requestDeserialize: (value) => TelemetrySettingRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Empty.encode(value).finish()),
        responseDeserialize: (value) => Empty.decode(value),
    },
    setWelcomeViewCompleted: {
