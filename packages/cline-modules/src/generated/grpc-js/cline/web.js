...
export const WebServiceService = {
    checkIsImageUrl: {
        ...
        responseSerialize: (value) => Buffer.from(IsImageUrl.encode(value).finish()),
        responseDeserialize: (value) => IsImageUrl.decode(value),
    },
    fetchOpenGraphData: {
        ...
        requestSerialize: (value) => Buffer.from(StringRequest.encode(value).finish()),
        requestDeserialize: (value) => StringRequest.decode(value),
        responseSerialize: (value) => Buffer.from(OpenGraphData.encode(value).finish()),
        responseDeserialize: (value) => OpenGraphData.decode(value),
    },
    openInBrowser: {
