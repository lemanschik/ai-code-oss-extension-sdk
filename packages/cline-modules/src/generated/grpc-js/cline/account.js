...
export const AccountServiceService = {
    ...
    subscribeToAuthStatusUpdate: {
        ...
        requestSerialize: (value) => Buffer.from(EmptyRequest.encode(value).finish()),
        requestDeserialize: (value) => EmptyRequest.decode(value),
        responseSerialize: (value) => Buffer.from(AuthState.encode(value).finish()),
        responseDeserialize: (value) => AuthState.decode(value),
    },
    /**
     * Handles authentication state changes from the Firebase context.
     * Updates the user info in global state and returns the updated value.
    ...
    authStateChanged: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(AuthStateChangedRequest.encode(value).finish()),
        requestDeserialize: (value) => AuthStateChangedRequest.decode(value),
        responseSerialize: (value) => Buffer.from(AuthState.encode(value).finish()),
        responseDeserialize: (value) => AuthState.decode(value),
    },
    /**
    ...
    getUserCredits: {
        ...
        requestSerialize: (value) => Buffer.from(EmptyRequest.encode(value).finish()),
        requestDeserialize: (value) => EmptyRequest.decode(value),
        responseSerialize: (value) => Buffer.from(UserCreditsData.encode(value).finish()),
        responseDeserialize: (value) => UserCreditsData.decode(value),
    },
    getOrganizationCredits: {
        path: "/cline.AccountService/getOrganizationCredits",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(GetOrganizationCreditsRequest.encode(value).finish()),
        requestDeserialize: (value) => GetOrganizationCreditsRequest.decode(value),
        responseSerialize: (value) => Buffer.from(OrganizationCreditsData.encode(value).finish()),
        responseDeserialize: (value) => OrganizationCreditsData.decode(value),
    },
    /**
     * Fetches all user organizations data
     * Returns a list of UserOrganization objects
    ...
    getUserOrganizations: {
        ...
        requestSerialize: (value) => Buffer.from(EmptyRequest.encode(value).finish()),
        requestDeserialize: (value) => EmptyRequest.decode(value),
        responseSerialize: (value) => Buffer.from(UserOrganizationsResponse.encode(value).finish()),
        responseDeserialize: (value) => UserOrganizationsResponse.decode(value),
    },
    setUserOrganization: {
        path: "/cline.AccountService/setUserOrganization",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(UserOrganizationUpdateRequest.encode(value).finish()),
        requestDeserialize: (value) => UserOrganizationUpdateRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Empty.encode(value).finish()),
        responseDeserialize: (value) => Empty.decode(value),
    },
};
