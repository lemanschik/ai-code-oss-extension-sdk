...
export const BrowserServiceService = {
    getBrowserConnectionInfo: {
        ...
        responseSerialize: (value) => Buffer.from(BrowserConnectionInfo.encode(value).finish()),
        responseDeserialize: (value) => BrowserConnectionInfo.decode(value),
    },
    testBrowserConnection: {
        ...
        responseSerialize: (value) => Buffer.from(BrowserConnection.encode(value).finish()),
        responseDeserialize: (value) => BrowserConnection.decode(value),
    },
    discoverBrowser: {
    ...
    getDetectedChromePath: {
        ...
        requestSerialize: (value) => Buffer.from(EmptyRequest.encode(value).finish()),
        requestDeserialize: (value) => EmptyRequest.decode(value),
        responseSerialize: (value) => Buffer.from(ChromePath.encode(value).finish()),
        responseDeserialize: (value) => ChromePath.decode(value),
    },
    updateBrowserSettings: {
        path: "/cline.BrowserService/updateBrowserSettings",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(UpdateBrowserSettingsRequest.encode(value).finish()),
        requestDeserialize: (value) => UpdateBrowserSettingsRequest.decode(value),
