...
export const WatchServiceService = {
    ...
    subscribeToFile: {
        ...
        requestStream: false,
        responseStream: true,
        requestSerialize: (value) => Buffer.from(SubscribeToFileRequest.encode(value).finish()),
        requestDeserialize: (value) => SubscribeToFileRequest.decode(value),
        responseSerialize: (value) => Buffer.from(FileChangeEvent.encode(value).finish()),
        responseDeserialize: (value) => FileChangeEvent.decode(value),
    },
};
