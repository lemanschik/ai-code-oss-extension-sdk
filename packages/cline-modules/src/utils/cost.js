function calculateApiCostInternal(modelInfo, inputTokens, // Note: For OpenAI-style, this is non-cached tokens. For Anthropic-style, this is total input tokens.
outputTokens, cacheCreationInputTokens, cacheReadInputTokens, totalInputTokensForPricing, // The *total* input tokens, used for tiered pricing lookup
...
export function calculateApiCostAnthropic(modelInfo, inputTokens, outputTokens, cacheCreationInputTokens, cacheReadInputTokens, thinkingBudgetTokens) {
    ...
    return calculateApiCostInternal(modelInfo, inputTokens, outputTokens, cacheCreationInputTokensNum, cacheReadInputTokensNum, inputTokens, thinkingBudgetTokens);
}
// For OpenAI compliant usage, the input tokens count INCLUDES the cached tokens
export function calculateApiCostOpenAI(modelInfo, inputTokens, // For OpenAI-style, this includes cached tokens
outputTokens, cacheCreationInputTokens, cacheReadInputTokens, thinkingBudgetTokens) {
    const cacheCreationInputTokensNum = cacheCreationInputTokens || 0;
    const cacheReadInputTokensNum = cacheReadInputTokens || 0;
    ...
    return calculateApiCostInternal(modelInfo, nonCachedInputTokens, outputTokens, cacheCreationInputTokensNum, cacheReadInputTokensNum, inputTokens, thinkingBudgetTokens);
}
