...
export class HostProvider {
    ...
    constructor(createWebviewProvider, createDiffViewProvider, hostBridge, logToChannel) {
    ...
    static initialize(webviewProviderCreator, diffViewProviderCreator, hostBridgeProvider, logToChannel) {
        if (HostProvider.instance) {
            throw new Error("Host providers have already been initialized.");
        }
        HostProvider.instance = new HostProvider(webviewProviderCreator, diffViewProviderCreator, hostBridgeProvider, logToChannel);
