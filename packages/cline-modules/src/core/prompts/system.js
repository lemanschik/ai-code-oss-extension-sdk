...
import { USE_EXPERIMENTAL_CLAUDE4_FEATURES } from "../task/index";
export const SYSTEM_PROMPT = async (cwd, supportsBrowserUse, mcpHub, browserSettings, isNextGenModel = false) => {
...
export function addUserInstructions(globalClineRulesFileInstructions, localClineRulesFileInstructions, localCursorRulesFileInstructions, localCursorRulesDirInstructions, localWindsurfRulesFileInstructions, clineIgnoreInstructions, preferredLanguageInstructions) {
