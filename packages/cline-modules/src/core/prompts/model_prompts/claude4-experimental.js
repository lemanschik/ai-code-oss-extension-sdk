...
import { createAntmlToolPrompt, } from "./jsonToolToXml";
import { bashToolDefinition } from "../../tools/bashTool";
import { readToolDefinition } from "../../tools/readTool";
import { writeToolDefinition } from "../../tools/writeTool";
import { lsToolDefinition } from "../../tools/lsTool";
import { grepToolDefinition } from "../../tools/grepTool";
import { webFetchToolDefinition } from "../../tools/webFetchTool";
import { askQuestionToolDefinition } from "../../tools/askQuestionTool";
import { useMCPToolDefinition } from "../../tools/useMcpTool";
import { listCodeDefinitionNamesToolDefinition } from "../../tools/listCodeDefinitionNamesTool";
import { accessMcpResourceToolDefinition } from "../../tools/accessMcpResourceTool";
import { planModeRespondToolDefinition } from "../../tools/planModeRespondTool";
import { loadMcpDocumentationToolDefinition } from "../../tools/loadMcpDocumentationTool";
import { attemptCompletionToolDefinition } from "../../tools/attemptCompletionTool";
import { browserActionToolDefinition } from "../../tools/browserActionTool";
import { newTaskToolDefinition } from "../../tools/newTaskTool";
import { editToolDefinition } from "../../tools/editTool";
export const SYSTEM_PROMPT_CLAUDE4_EXPERIMENTAL = async (cwd, supportsBrowserUse, mcpHub, browserSettings) => {
