 ...
 */
export type StreamingMethodHandler = (controller: Controller, message: any, responseStream: StreamingResponseHandler<any>, requestId?: string) => Promise<void>;
/**
...
export declare class ServiceRegistry {
     ...
     */
    handleRequest(controller: Controller, method: string, message: any): Promise<any>;
    /**
     ...
     */
    handleStreamingRequest(controller: Controller, method: string, message: any, responseStream: StreamingResponseHandler<any>, requestId?: string): Promise<void>;
}
/**
