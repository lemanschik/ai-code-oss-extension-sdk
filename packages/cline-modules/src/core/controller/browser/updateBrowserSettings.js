...
export async function updateBrowserSettings(controller, request) {
    try {
        ...
        const currentSettings = (await getGlobalState(controller.context, "browserSettings"));
        ...
        const newBrowserSettings = {
            ...
            remoteBrowserEnabled: request.remoteBrowserEnabled === undefined
                ? mergedWithDefaults.remoteBrowserEnabled
                : request.remoteBrowserEnabled,
            remoteBrowserHost: request.remoteBrowserHost === undefined ? mergedWithDefaults.remoteBrowserHost : request.remoteBrowserHost,
