...
const activeWorkspaceUpdateSubscriptions = new Set();
/**
 ...
 */
export async function subscribeToWorkspaceUpdates(_controller, _request, responseStream, requestId) {
 ...
 */
export async function sendWorkspaceUpdateEvent(filePaths) {
