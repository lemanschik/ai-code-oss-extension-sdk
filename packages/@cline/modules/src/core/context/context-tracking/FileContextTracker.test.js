...
describe("FileContextTracker", () => {
    ...
    beforeEach(() => {
        ...
        HostProvider.reset();
        HostProvider.initialize(((_) => { }), (() => { }), vscodeHostBridgeClient, (_) => { });
    ...
    it("should add a record when a file is edited by Cline", async () => {
        ...
        const activeEntry = savedMetadata.files_in_context.find((entry) => entry.path === filePath && entry.record_state === "active");
