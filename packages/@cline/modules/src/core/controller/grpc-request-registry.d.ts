 ...
 */
export declare class GrpcRequestRegistry {
    /**
     ...
     */
    registerRequest(requestId: string, cleanup: () => void, metadata?: any, responseStream?: StreamingResponseHandler<any>): void;
    /**
     ...
     */
    getAllRequests(): [string, RequestInfo][];
    /**
