    ...
    describe("handleGrpcRequest", () => {
        describe("Unary requests", () => {
            it("should handle successful unary requests", async () => {
                ...
                await handleGrpcRequest(mockController, request);
        ...
        describe("Streaming requests", () => {
            it("should handle successful streaming requests", async () => {
                ...
                mockStreamingHandler.callsFake(async (controller, message, responseStream, requestId) => {
        ...
        describe("handleGrpcRequestCancel", () => {
            it("should cancel an active request", async () => {
                ...
                await handleGrpcRequestCancel(mockController, cancelRequest);
        ...
        describe("Concurrent requests", () => {
            it("should handle concurrent requests", async () => {
                ...
                mockStreamingHandler.callsFake(async (controller, message, responseStream) => {
                    await responseStream({ value: "stream1" }, false, 0);
                    await responseStream({ value: "stream2" }, true, 1);
                });
                // Send multiple requests concurrently
                const requests = [
                    handleGrpcRequest(mockController, {
                        service: serviceName,
                        method: "testUnary",
                        message: { id: 1 },
