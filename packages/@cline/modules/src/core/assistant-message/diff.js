        ...
        if (isSearchBlockEnd(line)) {
            ...
            if (!currentSearchContent) {
                ...
                if (originalContent.length === 0) {
                    ...
                    throw new Error("Empty SEARCH block detected with non-empty file. This usually indicates a malformed SEARCH marker.\n" +
...
class NewFileContentConstructor {
    ...
    updateProcessingState(newState) {
        const isValidTransition = (this.state === ProcessingState.Idle && newState === ProcessingState.StateSearch) ||
