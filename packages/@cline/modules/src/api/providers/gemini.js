    ...
    async *createMessage(systemPrompt, messages) {
        ...
        try {
            ...
            if (error instanceof Error) {
                ...
                const isRateLimit = error.name === "ClientError" && rateLimitPatterns.some((pattern) => pattern.test(error.message));
                if (isRateLimit) {
            ...
            const throughputTokensPerSecSdk = totalDurationSdkMs > 0 && outputTokens > 0 ? outputTokens / (totalDurationSdkMs / 1000) : undefined;
