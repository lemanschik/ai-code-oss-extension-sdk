...
import { type handleServerStreamingCall, type UntypedServiceImplementation } from "../../../grpc/grpc-js";
...
export declare const WatchServiceService: {
    /** Subscribe to file changes */
    readonly subscribeToFile: {
        readonly path: "/host.WatchService/subscribeToFile";
        readonly requestStream: false;
        readonly responseStream: true;
        readonly requestSerialize: (value: SubscribeToFileRequest) => Buffer;
        readonly requestDeserialize: (value: Buffer) => SubscribeToFileRequest;
        readonly responseSerialize: (value: FileChangeEvent) => Buffer;
        readonly responseDeserialize: (value: Buffer) => FileChangeEvent;
    };
};
export interface WatchServiceServer extends UntypedServiceImplementation {
    /** Subscribe to file changes */
    subscribeToFile: handleServerStreamingCall<SubscribeToFileRequest, FileChangeEvent>;
}
