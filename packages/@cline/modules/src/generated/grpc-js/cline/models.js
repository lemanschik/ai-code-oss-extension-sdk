...
export function apiProviderFromJSON(object) {
    switch (object) {
        case 0:
        case "ANTHROPIC":
...
export function apiProviderToJSON(object) {
    switch (object) {
    ...
    fromJSON(object) {
        return {
            models: globalThis.Array.isArray(object?.models)
                ? object.models.map((e) => LanguageModelChatSelector.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
...
function createBaseLanguageModelChatSelector() {
...
function createBaseUpdateApiConfigurationRequest() {
...
function createBaseOpenAiCompatibleModelInfo() {
    return {
        maxTokens: undefined,
        contextWindow: undefined,
        supportsImages: undefined,
...
function createBaseLiteLLMModelInfo() {
    return {
        maxTokens: undefined,
        contextWindow: undefined,
        supportsImages: undefined,
...
function createBaseModelsApiConfiguration() {
    return {
        apiKey: undefined,
...
export const ModelsApiConfiguration = {
    encode(message, writer = new BinaryWriter()) {
        ...
        Object.entries(message.openAiHeaders).forEach(([key, value]) => {
            ModelsApiConfiguration_OpenAiHeadersEntry.encode({ key: key, value }, writer.uint32(58).fork()).join();
        });
        ...
        if (message.huaweiCloudMaasApiKey !== undefined) {
            writer.uint32(490).string(message.huaweiCloudMaasApiKey);
        }
        if (message.basetenApiKey !== undefined) {
            writer.uint32(498).string(message.basetenApiKey);
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 100: {
                    ...
                    message.planModeApiProvider = reader.int32();
                    continue;
                }
                case 101: {
                    if (tag !== 810) {
                ...
                case 200: {
                    ...
                    message.actModeApiProvider = reader.int32();
                    continue;
                }
                case 201: {
                    if (tag !== 1610) {
    ...
    fromJSON(object) {
        return {
            ...
            openAiHeaders: isObject(object.openAiHeaders)
                ? Object.entries(object.openAiHeaders).reduce((acc, [key, value]) => {
    ...
    fromPartial(object) {
        ...
        message.openAiHeaders = Object.entries(object.openAiHeaders ?? {}).reduce((acc, [key, value]) => {
            if (value !== undefined) {
...
function createBaseModelsApiConfiguration_OpenAiHeadersEntry() {
    return { key: "", value: "" };
}
export const ModelsApiConfiguration_OpenAiHeadersEntry = {
    encode(message, writer = new BinaryWriter()) {
        if (message.key !== "") {
            writer.uint32(10).string(message.key);
        }
...
export const ModelsServiceService = {
    ...
    getVsCodeLmModels: {
        ...
        responseSerialize: (value) => Buffer.from(VsCodeLmModelsArray.encode(value).finish()),
        responseDeserialize: (value) => VsCodeLmModelsArray.decode(value),
    },
    /** Refreshes and returns OpenRouter models */
    refreshOpenRouterModels: {
        ...
        requestSerialize: (value) => Buffer.from(EmptyRequest.encode(value).finish()),
        requestDeserialize: (value) => EmptyRequest.decode(value),
        responseSerialize: (value) => Buffer.from(OpenRouterCompatibleModelInfo.encode(value).finish()),
        responseDeserialize: (value) => OpenRouterCompatibleModelInfo.decode(value),
    },
    /** Refreshes and returns Hugging Face models */
    refreshHuggingFaceModels: {
    ...
    refreshOpenAiModels: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(OpenAiModelsRequest.encode(value).finish()),
        requestDeserialize: (value) => OpenAiModelsRequest.decode(value),
        responseSerialize: (value) => Buffer.from(StringArray.encode(value).finish()),
        responseDeserialize: (value) => StringArray.decode(value),
    },
    /** Refreshes and returns Requesty models */
    ...
    updateApiConfigurationProto: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(UpdateApiConfigurationRequest.encode(value).finish()),
        requestDeserialize: (value) => UpdateApiConfigurationRequest.decode(value),
