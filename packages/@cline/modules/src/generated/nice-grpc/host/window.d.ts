...
export interface WindowServiceImplementation<CallContextExt = {}> {
    /** Opens a text document in the editor and returns editor information. */
    showTextDocument(request: ShowTextDocumentRequest, context: CallContext & CallContextExt): Promise<DeepPartial<TextEditorInfo>>;
    showOpenDialogue(request: ShowOpenDialogueRequest, context: CallContext & CallContextExt): Promise<DeepPartial<SelectedResources>>;
    showMessage(request: ShowMessageRequest, context: CallContext & CallContextExt): Promise<DeepPartial<SelectedResponse>>;
    showInputBox(request: ShowInputBoxRequest, context: CallContext & CallContextExt): Promise<DeepPartial<ShowInputBoxResponse>>;
    showSaveDialog(request: ShowSaveDialogRequest, context: CallContext & CallContextExt): Promise<DeepPartial<ShowSaveDialogResponse>>;
    openFile(request: OpenFileRequest, context: CallContext & CallContextExt): Promise<DeepPartial<OpenFileResponse>>;
    getOpenTabs(request: GetOpenTabsRequest, context: CallContext & CallContextExt): Promise<DeepPartial<GetOpenTabsResponse>>;
    getVisibleTabs(request: GetVisibleTabsRequest, context: CallContext & CallContextExt): Promise<DeepPartial<GetVisibleTabsResponse>>;
}
export interface WindowServiceClient<CallOptionsExt = {}> {
    /** Opens a text document in the editor and returns editor information. */
    showTextDocument(request: DeepPartial<ShowTextDocumentRequest>, options?: CallOptions & CallOptionsExt): Promise<TextEditorInfo>;
    showOpenDialogue(request: DeepPartial<ShowOpenDialogueRequest>, options?: CallOptions & CallOptionsExt): Promise<SelectedResources>;
    showMessage(request: DeepPartial<ShowMessageRequest>, options?: CallOptions & CallOptionsExt): Promise<SelectedResponse>;
    showInputBox(request: DeepPartial<ShowInputBoxRequest>, options?: CallOptions & CallOptionsExt): Promise<ShowInputBoxResponse>;
    showSaveDialog(request: DeepPartial<ShowSaveDialogRequest>, options?: CallOptions & CallOptionsExt): Promise<ShowSaveDialogResponse>;
    openFile(request: DeepPartial<OpenFileRequest>, options?: CallOptions & CallOptionsExt): Promise<OpenFileResponse>;
    getOpenTabs(request: DeepPartial<GetOpenTabsRequest>, options?: CallOptions & CallOptionsExt): Promise<GetOpenTabsResponse>;
    getVisibleTabs(request: DeepPartial<GetVisibleTabsRequest>, options?: CallOptions & CallOptionsExt): Promise<GetVisibleTabsResponse>;
}
