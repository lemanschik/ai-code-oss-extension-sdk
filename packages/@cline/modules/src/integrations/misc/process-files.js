...
import { ShowMessageType, ShowOpenDialogueRequest } from "../../shared/proto/host/window";
/**
...
export async function selectFiles(imagesAllowed) {
    ...
    const showDialogueResponse = await HostProvider.window.showOpenDialogue(ShowOpenDialogueRequest.create({
        canSelectMany: true,
        openLabel: "Select",
        filters: {
