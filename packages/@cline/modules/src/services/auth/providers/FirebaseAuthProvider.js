...
export class FirebaseAuthProvider {
    ...
    async retrieveClineAuthInfo(controller) {
        ...
        try {
            ...
            const googleAccessTokenResponse = await axios.post(`https://securetoken.googleapis.com/v1/token?key=${firebaseApiKey}`, `grant_type=refresh_token&refresh_token=${encodeURIComponent(userRefreshToken)}`, {
                headers: {
