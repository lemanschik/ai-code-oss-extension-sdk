...
import { CallToolResultSchema, ListResourcesResultSchema, ListResourceTemplatesResultSchema, ListToolsResultSchema, ReadResourceResultSchema, } from "../../modelcontextprotocol/sdk/types";
...
export class McpHub {
    ...
    constructor(getMcpServersPath, getSettingsDirectoryPath, clientVersion) {
  ...
  "mcpServers": {
    ...
    async watchMcpSettingsFile() {
        ...
        const cancelSubscription = HostProvider.watch.subscribeToFile(SubscribeToFileRequest.create({
            path: settingsPath,
        }), {
