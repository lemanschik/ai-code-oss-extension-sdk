...
export const SubscribeToFileRequest: MessageFns<SubscribeToFileRequest> = {
  ...
  create(base?: DeepPartial<SubscribeToFileRequest>): SubscribeToFileRequest {
    return SubscribeToFileRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<SubscribeToFileRequest>): SubscribeToFileRequest {
    const message = createBaseSubscribeToFileRequest();
...
export const FileChangeEvent: MessageFns<FileChangeEvent> = {
  ...
  create(base?: DeepPartial<FileChangeEvent>): FileChangeEvent {
    return FileChangeEvent.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<FileChangeEvent>): FileChangeEvent {
    const message = createBaseFileChangeEvent();
    message.path = object.path ?? "";
...
export interface WatchServiceImplementation<CallContextExt = {}> {
  ...
  ): ServerStreamingMethodResult<DeepPartial<FileChangeEvent>>;
}

export interface WatchServiceClient<CallOptionsExt = {}> {
  /** Subscribe to file changes */
  subscribeToFile(
    request: DeepPartial<SubscribeToFileRequest>,
