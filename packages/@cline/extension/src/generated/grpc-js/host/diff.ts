...
export const DiffServiceService = {
  ...
  closeDiff: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CloseDiffRequest) => Buffer.from(CloseDiffRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CloseDiffRequest.decode(value),
    responseSerialize: (value: CloseDiffResponse) => Buffer.from(CloseDiffResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CloseDiffResponse.decode(value),
  },
} as const;
