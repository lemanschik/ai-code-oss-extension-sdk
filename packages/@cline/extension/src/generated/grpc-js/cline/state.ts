...
export const StateServiceService = {
  ...
  updateDefaultTerminalProfile: {
    ...
    responseSerialize: (value: TerminalProfileUpdateResponse) =>
      Buffer.from(TerminalProfileUpdateResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => TerminalProfileUpdateResponse.decode(value),
  },
  getAvailableTerminalProfiles: {
...
export interface StateServiceServer extends UntypedServiceImplementation {
  ...
  updateDefaultTerminalProfile: handleUnaryCall<StringRequest, TerminalProfileUpdateResponse>;
